...
class LeNet(MetaModule):
    def __init__(self, n_out):
        ...
        layers = [MetaConv2d(1, 6, 3, padding=1), nn.MaxPool2d(3, stride=2, padding=1), nn.ReLU(),
                  MetaConv2d(6, 16, 3, padding=1), nn.MaxPool2d(3, stride=2, padding=1), nn.ReLU(),
                  MetaConv2d(16, 120, 3, padding=1), nn.ReLU()]

        self.main = nn.Sequential(*layers)

        layers = [MetaLinear(120 * 7 * 7, 84),
                  nn.ReLU(),
                  MetaLinear(84, n_out)]
