...
def train(args, labeled_trainloader, unlabeled_trainloader, test_loader,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for batch_idx in range(args.eval_step):
            ...
            pseudo_label_1 = torch.softmax(logits_x.detach(), dim=-1)
            max_probs_1, targets_x_1 = torch.max(pseudo_label_1, dim=-1)
    ...
    try:
        ...
        df = pd.DataFrame({png_title: test_accs})
        df.to_csv(csv_name)
